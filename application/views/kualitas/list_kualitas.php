			...
			<div class="col-xl-12">						
                <div class="card mb-3">
                    <div class="card-header">                    
                        <h3 class='box-title'><?php echo anchor('kualitas/create', '<i class="fa fa-plus"> </i> Tambah Data', array('class' => 'btn btn-sm btn-primary')); ?>
                        </h3>
                    </div>                        
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <p>NB :</p>
                            <p>1. A kualitas nomer 1</p>
                            <p>2. B kualitas nomer 2</p>
                        </div>
                    </div>
                </div>                        
            </div>														
